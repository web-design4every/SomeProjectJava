 ...
 * @author Admin
 */
public class Exercise4_4 extends javax.swing.JFrame implements DocumentListener{
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"String after reverse: " + rv);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exercise4_4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Exercise4_4().setVisible(true);
            }
        });
    }
