 ...
 * @author Admin
 */
public class Exercise4_6 extends javax.swing.JFrame implements DocumentListener{
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        for (String s : myList) {
         ...
         JOptionPane.showMessageDialog(null, "Longest string element in array: "+longestString);
    ...
    private void btn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn4ActionPerformed
        ...
        myList.add(s);
        txtb.setText(String.valueOf(myList));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exercise4_6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Exercise4_6().setVisible(true);
            }
        });
    }
