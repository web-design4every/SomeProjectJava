 ...
 * @author Admin
 */
public class BieuThuc_2_3 extends javax.swing.JFrame implements DocumentListener{

    /**
     * Creates new form BieuThuc_2_3
     */
    public BieuThuc_2_3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("S = 1 + 1/(1!+2!) + 1/(1!+2!+3!) +...+ 1/(1!+2!+...+N!)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BieuThuc_2_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BieuThuc_2_3().setVisible(true);
            }
        });
    }
